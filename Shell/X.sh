...
SCRIPTS_PATH=$JD_PATH/jd/sctipts
...
#端口
input_port_num() {
    echo -n -e "\e[33m四.请输入要访问控制面板的端口[默认为：5684]->\e[0m"
    read input_port_num
...
if [ ! -f "$CONFIG_PATH/config.sh" ]; then
    ...
    #添加脚本作者助力码
    sed -i 's/ForOtherFruit1=""/ForOtherFruit1="118ef90ea2be4106ab45f3ff31c2a8f1@73b9c21c192948c6b9202303439510d2"/g' $CONFIG_PATH/config.sh
    sed -i 's/ForOtherBean1=""/ForOtherBean1="olmijoxgmjutyw3xraw4bu7jkcdvszaezqfffiq@iu237u55hwjiobiy5l2ouqbrmuay6e3tf5t45xq"/g' $CONFIG_PATH/config.sh
    sed -i 's/ForOtherJdzz1=""/ForOtherJdzz1="S5KgxAldC@S5awtF0VIqwO4c1K9@S4qggGEtb9FXX@S5q8yGkJTrQ"/g' $CONFIG_PATH/config.sh #京东赚赚
    sed -i 's/ForOtherSgmh1=""/ForOtherSgmh1="T0225KkcRh5K9VeDJR3wk6ULdACjVWmIaW5kRrbA@T0205KkcI0ZmnCe9Xm638bZACjVWmIaW5kRrbA"/g' $CONFIG_PATH/config.sh #闪购盲盒
    sed -i 's/ForOtherPet1=""/ForOtherPet1="MTAxODc2NTEzNTAwMDAwMDAyNzQ1OTEzOQ==@MTE1NDQ5OTIwMDAwMDAwMzY1OTM3NzM="/g' $CONFIG_PATH/config.sh #东东萌宠
 fi
