## Version: v3.14.0
## Date: 2021-01-13
## Update Content: 修复：PURCHASE_SHOPS应当export。

## 上面版本号中，如果第2位数字有变化，那么代表增加了新的参数，如果只有第3位数字有变化，仅代表更新了注释，没有增加新的参数，可更新可不更新
## 如需更新，请参考WIKI（https://github.com/EvineDeng/jd-base/wiki）中"如何更新配置文件"部分的操作说明，进行智能比对后修改。

################################## 说明 ##################################
## 以下配置中，带有 export 申明的，均由lxk0301大佬定义，详见：https://github.com/lxk0301/jd_scripts/blob/master/githubAction.md#%E4%B8%8B%E6%96%B9%E6%8F%90%E4%BE%9B%E4%BD%BF%E7%94%A8%E5%88%B0%E7%9A%84-secrets%E5%85%A8%E9%9B%86%E5%90%88
...
## 2. 还可以通过浏览器开发工具获取，此方式获得的Cookie只有1个月有效期，教程：https://github.com/lxk0301/jd_scripts/wiki/GetCookies
...
## 相关讨论详见https://github.com/lxk0301/jd_scripts/issues/127，如需使用，请自行解除下一行注释
...
## 2. BARK，教程（看BARK_PUSH和BARK_SOUND的说明）：https://github.com/lxk0301/jd_scripts/0blob/master/githubAction.md#%E4%B8%8B%E6%96%B9%E6%8F%90%E4%BE%9B%E4%BD%BF%E7%94%A8%E5%88%B0%E7%9A%84-secrets%E5%85%A8%E9%9B%86%E5%90%88
export BARK_PUSH=""
export BARK_SOUND="choo"

## 3. Telegram，如需使用，TG_BOT_TOKEN和TG_USER_ID必须同时赋值，教程：https://github.com/lxk0301/jd_scripts/blob/master/backUp/TG_PUSH.md
export TG_BOT_TOKEN=""
export TG_USER_ID=""

## 4. 钉钉，教程（看DD_BOT_TOKEN和DD_BOT_SECRET部分）：https://github.com/lxk0301/jd_scripts/blob/master/githubAction.md#%E4%B8%8B%E6%96%B9%E6%8F%90%E4%BE%9B%E4%BD%BF%E7%94%A8%E5%88%B0%E7%9A%84-secrets%E5%85%A8%E9%9B%86%E5%90%88
export DD_BOT_TOKEN=""
...
## 9. 企业微信应用消息推送的值，见https://github.com/lxk0301/jd_scripts/issues/519，文档：https://work.weixin.qq.com/api/doc/90000/90135/90236 
...
MyFruit1="118ef90ea2be4106ab45f3ff31c2a8f1"
MyFruit2="73b9c21c192948c6b9202303439510d2"
MyFruit3="024a7cad6aa14357966bf03fdc1e7077"
MyFruit4=""
MyFruit5=""
MyFruit6=""
MyFruitA="024a7cad6aa14357966bf03fdc1e7077"
MyFruitB="b1d3ce634a0740108236f24c86a1c1cf"

ForOtherFruit1="${MyFruit2}@${MyFruit3}@${MyFruitA}@${MyFruitB}"
ForOtherFruit2="${MyFruit1}@${MyFruit3}@${MyFruitA}@${MyFruitB}"
ForOtherFruit3="${MyFruit1}@${MyFruit2}@${MyFruitA}@${MyFruitB}"
ForOtherFruit4=""
ForOtherFruit5=""
ForOtherFruit6=""
...
################################## 定义东东萌宠互助（选填） ##################################
## 具体填法及要求详见：https://github.com/EvineDeng/jd-base/wiki/FAQ
MyPet1="MTAxODc2NTEzNTAwMDAwMDAyNzQ1OTEzOQ=="
MyPet2="MTE1NDQ5OTIwMDAwMDAwMzY1OTM3NzM="
MyPet3="MTE1NDAxNzYwMDAwMDAwNDA1NDc1NTc="
MyPet4=""
MyPet5=""
MyPet6=""
MyPetA="MTE1NDQ5OTUwMDAwMDAwMzc3MjUxNDU="
MyPetB="MTE1NDQ5OTIwMDAwMDAwNDI5MzA3OTk="

ForOtherPet1="${MyPet1}@${MyPet2}@${MyPet3}@${MyPetA}@${MyPetB}"
ForOtherPet2="${MyPet1}@${MyPet2}@${MyPet3}@${MyPetA}@${MyPetB}"
ForOtherPet3="${MyPet1}@${MyPet2}@${MyPet3}@${MyPetA}@${MyPetB}"
ForOtherPet4=""
ForOtherPet5=""
ForOtherPet6=""
...
################################## 定义种豆得豆互助（选填） ##################################
## 具体填法及要求详见：https://github.com/EvineDeng/jd-base/wiki/FAQ
MyBean1="olmijoxgmjutyw3xraw4bu7jkcdvszaezqfffiq"
MyBean2="iu237u55hwjiobiy5l2ouqbrmuay6e3tf5t45xq"
MyBean3="u72q4vdn3zes3icifz3p2wxz67litwp2t7t2zoa"
MyBean4=""
MyBean5=""
MyBean6=""
MyBeanA="7hi2z5qmko5v2nzyqy73544gwf44qq4ovid7kqq"
MyBeanB=""

ForOtherBean1="${MyBean2}@${MyBean3}@${MyBeanA}"
ForOtherBean2="${MyBean1}@${MyBean3}@${MyBeanA}"
ForOtherBean3="${MyBean1}@${MyBean2}@${MyBeanA}"
ForOtherBean4=""
ForOtherBean5=""
ForOtherBean6=""
...
################################## 定义京东赚赚互助（选填） ##################################
## 具体填法及要求详见：https://github.com/EvineDeng/jd-base/wiki/FAQ
MyJdzz1="S5KkcRh5K9VeDJR3wk6ULdA"
MyJdzz2="S5KkcI0ZmnCe9Xm638bZA"
MyJdzz3="S5KkcGEdelDGlQESm_a1p"
MyJdzz4=""
MyJdzz5=""
MyJdzz6=""
MyJdzzA="S-akbH2dIkxGFWG6VzZc"
MyJdzzB="S5KkcRRdI912Gckj0wqRcJw"

ForOtherJdzz1="${MyJdzz2}@${MyJdzz3}"
ForOtherJdzz2="${MyJdzz1}@${MyJdzz3}"
ForOtherJdzz3="${MyJdzz1}@${MyJdzz2}"
ForOtherJdzz4=""
ForOtherJdzz5=""
ForOtherJdzz6=""
...
################################## 定义疯狂的JOY互助（选填） ##################################
## 具体填法及要求详见：https://github.com/EvineDeng/jd-base/wiki/FAQ
MyJoy1="v6SnwcSXWk8K7x228LZX7Kt9zd5YaBeE"
MyJoy2="V862tzA2FtDZxcFGq0lzUw=="
MyJoy3="tkGFHxD1TRNYfI756LBPOg=="
MyJoy4=""
MyJoy5=""
MyJoy6=""
MyJoyA=""
...
ForOtherJoy1="${MyJoy2}@${MyJoy3}"
ForOtherJoy2="${MyJoy1}@${MyJoy3}"
ForOtherJoy3="${MyJoy1}@${MyJoy2}"
ForOtherJoy4=""
ForOtherJoy5=""
ForOtherJoy6=""
...
################################## 定义口袋书店每个人自己的互助码（选填） ##################################
## 具体填法及要求详见：https://github.com/EvineDeng/jd-base/wiki/FAQ
MyBookShop1="d46e98fa3ee64270ab53cd58f76849a4"
MyBookShop2=""
MyBookShop3=""
MyBookShop4=""
MyBookShop5=""
...
################################## 定义签到领现金互助（选填） ##################################
## 具体填法及要求详见：https://github.com/EvineDeng/jd-base/wiki/FAQ
MyCash1="eU9YauzhZv9y9GnRzCES1g"
MyCash2="eU9YD7TND49MjxqWrjJZ"
MyCash3=""
MyCash4=""
MyCash5=""
MyCash6=""
...
ForOtherCash1="${MyCash1}@${MyCash2}@${MyCashA}"
ForOtherCash2="${MyCash1}@${MyCash2}@${MyCashA}"
ForOtherCash3=""
ForOtherCash4=""
ForOtherCash5=""
ForOtherCash6=""
...
## 疯狂的JOY自动购买什么等级的JOY，如需要使用请自行解释注释
export BUY_JOY_LEVEL="29"
